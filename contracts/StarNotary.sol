...
contract StarNotary is ERC721Full {
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        Star memory starFound = tokenIdToStarInfo[_tokenId];
        return starFound.name;
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == owner1 || msg.sender == owner2, "The sender must be the owner of either of the tokens..");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == owner, "The sender is not the owner of the token");
